...
class blogController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('actualite.index')->with('success', 'Blog crée avec succès');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($blog) {
            ...
            if ($status) {
                return redirect()->route('actualite.index')->with('success', 'Blog modifiée avec succès');
            } else {
                return back()->with('error', 'something went wrong!');
            }
        } else {
    ...
    public function destroy($id)
    {
        ...
        if ($blog) {
            $status = $blog->delete();
            if ($status) {
                return redirect()->route('actualite.index')->with('success', 'Blog supprimée avec succès');
            } else {
                return back()->with('error', 'Something went wrong!');
            }
        } else {
