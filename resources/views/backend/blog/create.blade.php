        ...
        <div class="row small-spacing">
            <div class="col-xs-9">
                <div class="box-content card white">
                    <h4 class="box-title">Ajouter un Blog</h4>
                    <!-- /.box-title -->
                    <div class="col-md-12">
                        @if ($errors->any())
                        ...
                        <form action="{{route('actualite.store')}}" method="POST">
                            ...
                            <div class="form-group margin-bottom-20">
                                ...
                                <select class="form-control" name="type_blog">
                                        <option value="news" {{old('type_blog')=='news' ? 'selected' : ''}}>News</option>
                                        <option value="event" {{old('type_blog')=='event' ? 'selected' : ''}}>Evenement</option>
                                </select>
                            </div>
